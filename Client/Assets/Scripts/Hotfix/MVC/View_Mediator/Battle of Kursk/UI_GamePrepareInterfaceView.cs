...
// Class Description   :    UI_GamePrepareInterfaceView
...
namespace Game {
    public class UI_GamePrepareInterfaceView : GameView
    {
        public const string VIEW_NAME = "UI_GamePrepareInterface";

        public UI_GamePrepareInterfaceView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_GamePrepareInterfaceMediator mt = new UI_GamePrepareInterfaceMediator(vb.gameObject);
            mt.view = this;
