...
// Class Description   :    UI_JoinRoomPanelView
...
namespace Game {
    public class UI_JoinRoomPanelView : GameView
    {
        public const string VIEW_NAME = "UI_JoinRoomPanel";

        public UI_JoinRoomPanelView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_JoinRoomPanelMediator mt = new UI_JoinRoomPanelMediator(vb.gameObject);
            mt.view = this;
