...
// Class Description   :    UI_GamePrepareInterface_adminMediator
...
namespace Game {
    public class UI_GamePrepareInterface_adminMediator : GameMediator {
        #region Member
        public static string NameMediator = "UI_GamePrepareInterface_adminMediator";

        public static int number_Position = 1;
        ...
        //IMediatorPlug needs
        public UI_GamePrepareInterface_adminMediator(object viewComponent ):base(NameMediator, viewComponent ) {}


        public UI_GamePrepareInterface_adminView view;
                    ...
                    case Msg.MsgType.START_GAME_S2C:
                        {
                            ...
                            if (xMsg.result == 0)
                            { 
                                //TmpData.userInfos[number_Position - 1].position_number = number_Position;
                                //TmpData.userInfos[number_Position - 1].tank_type = type_Tank;
                                //TmpData.userInfos[number_Position - 1].user_name = name_User;
        ...
        private void enterscence()
        {
            int sceneId = 1;
            SendNotification(CmdConstant.EnterScenceCmd,sceneId);
        }
        ...
        {
          //  view.m_UI_StatWarBtn.AddClickEvent(enterscence);
        ...
        private void OnStartWar()
        {
          ...
          SendNotification(CmdConstant.StartWarCmd);
