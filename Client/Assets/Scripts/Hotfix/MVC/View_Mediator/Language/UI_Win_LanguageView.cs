...
// Class Description   :    UI_Win_LanguageView
...
namespace Game {
    public class UI_Win_LanguageView : GameView
    {
        public const string VIEW_NAME = "UI_Win_Language";

        public UI_Win_LanguageView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_Win_LanguageMediator mt = new UI_Win_LanguageMediator(vb.gameObject);
            mt.view = this;
