// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Position_Red_SubView
...
namespace Game {
    public partial class UI_Position_Red_SubView : UI_SubView
    {
		public const string VIEW_NAME = "UI_Position_Red";

        public UI_Position_Red_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Position_Red;
		...
		[HideInInspector] public LanguageText m_lbl_usenameText_LanguageText;
        ...
        {       
			m_UI_Position_Red = gameObject.GetComponent<RectTransform>();
			...
			m_lbl_usenameText_LanguageText = FindUI<LanguageText>(gameObject.transform ,"img_username/lbl_usenameText");
