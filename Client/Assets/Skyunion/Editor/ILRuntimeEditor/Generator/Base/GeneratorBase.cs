...
namespace CodeGenerationTools.Generator.Base
{
    public abstract class GeneratorBase<TData> : IGenerator
    {
        ...
        protected void SetKeyValue(string key, object content)
        {
            ...
            {
                UnityEngine.Debug.Log("Invalid key word "+key+" "+content);
                return;
            }
        ...
        public string Generate()
        {
            ...
            {
                UnityEngine.Debug.Log(string.Format("{0}'s Template  is null,please use LoadTemplate to init template", GetType().Name));
                return null;
            }
